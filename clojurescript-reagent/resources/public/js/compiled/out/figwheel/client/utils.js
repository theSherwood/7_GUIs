...
return (new CustomEvent(event_name,(function (){var obj28558 = ({"detail":data});
return obj28558;
})()));
} else {
...
var f = (function (){var pred__28565 = cljs.core._EQ_;
var expr__28566 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__28565.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__28566))){
return ((function (pred__28565,expr__28566){
return (function (p1__28559_SHARP_){
return console.warn(p1__28559_SHARP_);
});
;})(pred__28565,expr__28566))
} else {
if(cljs.core.truth_(pred__28565.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__28566))){
return ((function (pred__28565,expr__28566){
return (function (p1__28560_SHARP_){
return console.debug(p1__28560_SHARP_);
});
;})(pred__28565,expr__28566))
} else {
if(cljs.core.truth_(pred__28565.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__28566))){
return ((function (pred__28565,expr__28566){
return (function (p1__28561_SHARP_){
return console.error(p1__28561_SHARP_);
});
;})(pred__28565,expr__28566))
} else {
return ((function (pred__28565,expr__28566){
return (function (p1__28562_SHARP_){
return console.log(p1__28562_SHARP_);
});
;})(pred__28565,expr__28566))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__28569){
...
var opts = map__28570__$1;
var eval_fn = cljs.core.get.call(null,map__28570__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__28572_SHARP_);
});})(new_def))
);
...
return (function (p__28573){
var vec__28574 = p__28573;
var ky = cljs.core.nth.call(null,vec__28574,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1620419391987
