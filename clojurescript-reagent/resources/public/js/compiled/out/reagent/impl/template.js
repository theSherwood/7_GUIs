...
var G__21293 = o;
(G__21293[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__21295__i < G__21295__a.length) {G__21295__a[G__21295__i] = arguments[G__21295__i + 0]; ++G__21295__i;}
  args = new cljs.core.IndexedSeq(G__21295__a,0,null);
} 
...
var G__21297 = o;
(G__21297[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__21302 = props;
var G__21302__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__21302,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__21302);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__21302__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__21303){
...
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__21304,map__21304__$1,props,class$){
return (function (c){
...
});})(map__21304,map__21304__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__21306){
...
var on_write = cljs.core.get.call(null,map__21307__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__21307,map__21307__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__21307,map__21307__$1,on_write))
);
} else {
...
var G__21310 = jsprops;
(G__21310["defaultValue"] = value);

(G__21310["onChange"] = ((function (G__21310,v,value,on_change){
return (function (p1__21309_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__21309_SHARP_);
});})(G__21310,v,value,on_change))
);
...
var vec__21313 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__21313,(0),null);
var id = cljs.core.nth.call(null,vec__21313,(1),null);
var class$ = cljs.core.nth.call(null,vec__21313,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___21317 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5724__auto___21317 == null)){
} else {
var key_21318 = temp__5724__auto___21317;
(jsprops["key"] = key_21318);
}
...
var temp__5724__auto___21319 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5724__auto___21319 == null)){
} else {
var key_21320 = temp__5724__auto___21319;
reagent.impl.template.oset.call(null,jsprops,"key",key_21320);
}
...
var G__21321 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__21321["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq21325){
var G__21326 = cljs.core.first.call(null,seq21325);
var seq21325__$1 = cljs.core.next.call(null,seq21325);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21326,seq21325__$1);
});
...
break;
default:
var G__21332 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__21332;
continue;
...
var n__4607__auto___21334 = a.length;
var i_21335 = (0);
while(true){
if((i_21335 < n__4607__auto___21334)){
(a[i_21335] = reagent.impl.template.as_element.call(null,(a[i_21335])));

var G__21336 = (i_21335 + (1));
i_21335 = G__21336;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4607__auto___21337 = a.length;
var i_21338 = (0);
while(true){
if((i_21338 < n__4607__auto___21337)){
var val_21339 = (a[i_21338]);
if(((cljs.core.vector_QMARK_.call(null,val_21339)) && ((reagent.impl.template.key_from_vec.call(null,val_21339) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_21338] = reagent.impl.template.as_element.call(null,val_21339));
...
var ctx = ({});
var vec__21341 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__21341,(0),null);
var derefed = cljs.core.nth.call(null,vec__21341,(1),null);
...
var G__21344 = (cljs.core.count.call(null,argv) - first_child);
switch (G__21344) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__21344){
...
//# sourceMappingURL=template.js.map?rel=1620419386778
