...
var line = cljs.core.get.call(null,map__25118__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25118__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25117){var _e = e25117;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___25120 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___25120)){
var seen_errors_25121 = temp__5718__auto___25120;
if(cljs.core.truth_(seen_errors_25121.has(self))){
} else {
seen_errors_25121.add(self);

var temp__5720__auto___25122 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___25122)){
var sense_25123 = temp__5720__auto___25122;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25123)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1620419390714
