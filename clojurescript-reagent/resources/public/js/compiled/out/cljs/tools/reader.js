...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24732 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24732,ch);
...
if(("\\" === ch__$1)){
var ch_24733__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24733__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24733__$2);
} else {
}
...
var vec__24742 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24742,(0),null);
var start_column = cljs.core.nth.call(null,vec__24742,(1),null);
...
var G__24745 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24745;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__24746 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__24747 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__24747;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__24746;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__24748 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24748,(0),null);
var start_column = cljs.core.nth.call(null,vec__24748,(1),null);
...
var vec__24751 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24751,(0),null);
var end_column = cljs.core.nth.call(null,vec__24751,(1),null);
...
var vec__24754 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24754,(0),null);
var start_column = cljs.core.nth.call(null,vec__24754,(1),null);
...
var vec__24757 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24757,(0),null);
var end_column = cljs.core.nth.call(null,vec__24757,(1),null);
...
var vec__24760 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24760,(0),null);
var start_column = cljs.core.nth.call(null,vec__24760,(1),null);
...
var vec__24763 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24763,(0),null);
var end_column = cljs.core.nth.call(null,vec__24763,(1),null);
...
var sb = (function (){var G__24766 = (new goog.string.StringBuffer());
G__24766.append(initch);
...
var G__24768 = (function (){var G__24767 = sb;
G__24767.append(ch);

return G__24767;
})();
var G__24769 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24768;
ch = G__24769;
continue;
}
...
switch (G__24772) {
case "\\":
var G__24776 = (function (){var G__24773 = sb;
G__24773.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24773;
})();
var G__24777 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24776;
ch = G__24777;
continue;
...
break;
default:
var G__24778 = (function (){var G__24774 = sb;
G__24774.append(ch);

return G__24774;
})();
var G__24779 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24778;
ch = G__24779;
continue;
...
var G__24804 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24804,true,null,opts,pending_forms);
...
var G__24805 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24805)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24805)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24805)){
...
var _STAR_suppress_read_STAR__orig_val__24806 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24807 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24807;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24806;
}});
...
var G__24808 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__24808,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__24808,rdr,first_line);
...
var G__24812 = matched;
var G__24813 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__24812;
finished = G__24813;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__24814 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__24815 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__24815;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__24814;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__24816 = cljs.tools.reader.arg_env;
var arg_env_temp_val__24817 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__24817;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24818 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24818,"(");
...
var G__24819 = (i + (1));
var G__24820 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__24816;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24821 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24821);
...
var G__24822 = cljs.core.next.call(null,s__$1);
var G__24823 = ret;
s__$1 = G__24822;
r = G__24823;
continue;
...
var G__24824 = cljs.core.next.call(null,s);
var G__24825 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24824;
key_vals = G__24825;
continue;
} else {
...
var gensym_env_orig_val__24829 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__24830 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__24830;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__24829;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24831 = token;
var G__24831__$1 = (((G__24831 == null))?null:cljs.core.subs.call(null,G__24831,(1)));
var G__24831__$2 = (((G__24831__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24831__$1));
var G__24831__$3 = (((G__24831__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24831__$2));
var G__24831__$4 = (((G__24831__$3 == null))?null:cljs.core.symbol.call(null,G__24831__$3));
if((G__24831__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__24831__$4);
}
})():(function (){var G__24832 = token;
var G__24832__$1 = (((G__24832 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__24832));
if((G__24832__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__24832__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__24843,reader){
...
var opts = map__24844__$1;
var eof = cljs.core.get.call(null,map__24844__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24850){
...
//# sourceMappingURL=reader.js.map?rel=1620419390323
