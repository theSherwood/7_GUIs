...
var G__24665 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24665;
continue;
} else {
return ch;
...
var vec__24666 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__24666,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq24669){
...
return (function() { 
var G__24674__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__24674 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__24675__i = 0, G__24675__a = new Array(arguments.length -  1);
while (G__24675__i < G__24675__a.length) {G__24675__a[G__24675__i] = arguments[G__24675__i + 1]; ++G__24675__i;}
  _ = new cljs.core.IndexedSeq(G__24675__a,0,null);
} 
return G__24674__delegate.call(this,rdr,_);};
G__24674.cljs$lang$maxFixedArity = 1;
G__24674.cljs$lang$applyTo = (function (arglist__24676){
var rdr = cljs.core.first(arglist__24676);
var _ = cljs.core.rest(arglist__24676);
return G__24674__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1620419390113
